...
namespace QLDSV_TC {
    ...
    public partial class DS : global::System.Data.DataSet {
        ...
        public partial class Get_SubscribesDataTable : global::System.Data.TypedTableBase<Get_SubscribesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Get_SubscribesRow AddGet_SubscribesRow(string KHOA, string TENSERVER) {
        ...
        public partial class Get_SubscribesRow : global::System.Data.DataRow {
            ...
            public string KHOA {
                get {
                    try {
                        return ((string)(this[this.tableGet_Subscribes.KHOAColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'KHOA\' in table \'Get_Subscribes\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableGet_Subscribes.KHOAColumn] = value;
                }
            }
            ...
            public bool IsKHOANull() {
                return this.IsNull(this.tableGet_Subscribes.KHOAColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetKHOANull() {
                this[this.tableGet_Subscribes.KHOAColumn] = global::System.Convert.DBNull;
            }
...
SELECT MASV, NIENKHOA, HOCKY, NGAYDONG, SOTIENDONG, rowguid FROM CT_DONGHOCPHI WHERE (HOCKY = @HOCKY) AND (MASV = @MASV) AND (NGAYDONG = @NGAYDONG) AND (NIENKHOA = @NIENKHOA)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLDSV_TC.Properties.Settings.Default.QLDSVConnectionString;
        }
...
SELECT MASV, HO, TEN, PHAI, DIACHI, NGAYSINH, MALOP, DANGHIHOC, PASSWORD, rowguid FROM SINHVIEN WHERE (MASV = @MASV)";
    ...
    public partial class Get_SubscribesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT KHOA, TENSERVER FROM dbo.Get_Subscribes";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
